...
@section('title', 'Tạo mới danh mục bài viết')
@section('titleContent', 'Tạo mới danh mục bài viết')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="panel">
                ...
                <form action="{{ route('categoryNews.store') }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="panel-body">
                        <div class="col-12">
                            <label for="" class="form-label"><b>Tên danh mục</b></label>
                            <input type="text" class="form-control" name="new_cate_name" value="{{old('new_cate_name')}}">
